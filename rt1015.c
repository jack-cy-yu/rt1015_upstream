...
static const struct reg_sequence rt1015_init[] = {
	{ 0x0000, 0x0000 },
	{ 0x0104, 0xA213 },
	{ 0x010E, 0x0058 },
	{ 0x0111, 0x2000 },
...
#define RT1015_INIT_REG_LEN ARRAY_SIZE(rt1015_init)
...
static const char *rt1015_boost_mode[] = {
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	if (rt1015->boost_mode == 0) {
		/* Bypass */
		regmap_update_bits(rt1015->regmap, RT1015_SMART_BST_CTRL1,
			RT1015_ABST_AUTO_EN_MASK | RT1015_ABST_FIX_TGT_MASK |
			RT1015_BYPASS_SWR_REG_MASK, RT1015_ABST_REG_MODE |
			RT1015_ABST_FIX_TGT_DIS | RT1015_BYPASS_SWRREG_BYPASS);
	} else if (rt1015->boost_mode == 1) {
		/* Adaptive */
		regmap_update_bits(rt1015->regmap, RT1015_SMART_BST_CTRL1,
			RT1015_ABST_AUTO_EN_MASK | RT1015_ABST_FIX_TGT_MASK |
			RT1015_BYPASS_SWR_REG_MASK, RT1015_ABST_AUTO_MODE |
			RT1015_ABST_FIX_TGT_DIS | RT1015_BYPASS_SWRREG_PASS);
	} else {
		/* Fixed Adaptive */
		regmap_update_bits(rt1015->regmap, RT1015_SMART_BST_CTRL1,
			RT1015_ABST_AUTO_EN_MASK | RT1015_ABST_FIX_TGT_MASK |
			RT1015_BYPASS_SWR_REG_MASK, RT1015_ABST_AUTO_MODE |
			RT1015_ABST_FIX_TGT_EN | RT1015_BYPASS_SWRREG_PASS);
	}
...
static const struct snd_kcontrol_new rt1015_snd_controls[] = {
	...
	SOC_ENUM_EXT("Boost Mode", rt1015_boost_mode_enum, rt1015_boost_mode_get,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (rt1015->amp_ver == RT1015_VERB) {
			regmap_write(rt1015->regmap, RT1015_SYS_RST1, 0x05f7);
			regmap_write(rt1015->regmap, RT1015_GAT_BOOST, 0xacfe);
			regmap_write(rt1015->regmap, RT1015_PWR9, 0xaa00);
			regmap_write(rt1015->regmap, RT1015_GAT_BOOST, 0xecfe);
		}
		break;

	case SND_SOC_DAPM_POST_PMD:
		if (rt1015->amp_ver == RT1015_VERB) {
			regmap_write(rt1015->regmap, RT1015_PWR9, 0xa800);
			regmap_write(rt1015->regmap, RT1015_SYS_RST1, 0x05f5);
		}
		break;
	default:
		break;
...
static const struct snd_soc_dapm_widget rt1015_dapm_widgets[] = {
	SND_SOC_DAPM_SUPPLY("LDO2", RT1015_PWR1, RT1015_PWR_LDO2_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("INT RC CLK", RT1015_PWR1, RT1015_PWR_INTCLK_BIT, 0,
		NULL, 0),
	SND_SOC_DAPM_SUPPLY("ISENSE", RT1015_PWR1, RT1015_PWR_ISENSE_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("VSENSE", RT1015_PWR1, RT1015_PWR_VSENSE_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("PLL", RT1015_PWR1, RT1015_PWR_PLL_BIT, 0,
		NULL, 0),
	SND_SOC_DAPM_SUPPLY("BG1 BG2", RT1015_PWR1, RT1015_PWR_BG_1_2_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("MBIAS BG", RT1015_PWR1, RT1015_PWR_MBIAS_BG_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("VBAT", RT1015_PWR1, RT1015_PWR_VBAT_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("MBIAS", RT1015_PWR1, RT1015_PWR_MBIAS_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("ADCV", RT1015_PWR1, RT1015_PWR_ADCV_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("MIXERV", RT1015_PWR1, RT1015_PWR_MIXERV_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("SUMV", RT1015_PWR1, RT1015_PWR_SUMV_BIT, 0, NULL,
		0),
	SND_SOC_DAPM_SUPPLY("VREFLV", RT1015_PWR1, RT1015_PWR_VREFLV_BIT, 0, NULL,
		0),
